...
class EditAssignmentDetailsScreen extends StatelessWidget {
  EditAssignmentDetailsScreen({
    super.key,
  });
  final formKey = GlobalKey<FormState>();
  ImagePicker picker = ImagePicker();
  var controller = Get.isRegistered<EditAssignmentDetailsController>()
      ? Get.find<EditAssignmentDetailsController>()
      : Get.put(EditAssignmentDetailsController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Edit Assignment Details"),
        ),
        body: Obx(
                          ...
                          GestureDetector(
                            onTap: () async {
                              if (formKey.currentState!.validate()) {
                                bool next = await controller
                                    .editAssignmentDetails(context);
                                if (next == true) {
