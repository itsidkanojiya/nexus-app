    ...
    return SafeArea(
      ...
      body: (controller.favBookList.isEmpty)
          ...
          : const Padding(
              ...
              //   itemCount: controller.favBookList.length,
              ...
              //           controller.favBookList[index].coverLink ?? '',
              //           fit: BoxFit.fill,
              //           height: 50,
              //         ),
              //         trailing: const Icon(
              ...
              //           color: Style.primary,
              //         ),
              //         title:  Text(controller.favBookList[index].chapterName ?? ''),
              //         subtitle:  Text(controller.favBookList[index].name ?? ''),
