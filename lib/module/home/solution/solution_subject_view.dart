...
import 'package:nexus_app/module/home/solution/solution_view.dart';
import 'package:nexus_app/module/profile/profile_page.dart';
import 'package:nexus_app/theme/style.dart';

class SolutionSubjectView extends StatefulWidget {
  final String std;
  final String board;

  const SolutionSubjectView(
      {super.key, required this.std, required this.board});

  @override
  State<SolutionSubjectView> createState() => _SolutionSubjectViewState();
}

class _SolutionSubjectViewState extends State<SolutionSubjectView> {
  bool isSearch = false;
